                        ...
                        <div class="block-content collapse in">
                            <div class="span12">
                                ...
                                <div class="block-content collapse in">
                                    <div id="page-wrapper">
                                        <?php
                                        $result = mysqli_query($conn, "SELECT titheid, SUM(Amount) AS value_sum FROM tithe WHERE na = '$session_id' GROUP BY titheid");
                                        $row = mysqli_fetch_assoc($result);
                                        $sum = $row ? $row['value_sum'] : 0; 
                                        ...
                                        <div class="row-fluid">
                                            ...
                                            <?php
                                            $result1 = mysqli_query($conn, "SELECT offeringid, SUM(Amount) AS value_sum FROM offering WHERE na = '$session_id' GROUP BY offeringid");
                                            $row = mysqli_fetch_assoc($result1);
                                            $sum1 = $row ? $row['value_sum'] : 0; 
                                    ...
                                    <div id="page-wrapper">
                                        <?php
                                        $result2 = mysqli_query($conn, "select givingid, SUm(Amount) AS value_sum from giving where na='$session_id' GROUP BY givingid");
                                        $row = mysqli_fetch_assoc($result2);
                                        $sum2 = $row ? $row['value_sum'] : 0;
