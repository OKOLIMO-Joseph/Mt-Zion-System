								...
								<form action="delete_memberss.php" method="post">
									...
									<?php include('modal_delete.php'); ?>
										...
										<tbody>
												...
												<td width="120">
												<a rel="tooltip"  title="Edit member" id="e<?php echo $id; ?>" href="edit_visitor.php<?php echo '?id='.$id; ?>"  data-toggle="modal" class="btn btn-success"><i class="icon-pencil icon-large"> Edit</i></a>
												</td>
