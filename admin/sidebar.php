     ...
     <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
       ...
       <li>
         ...
         <ul id="bs7" class="collapse">
           ...
           <li class="">
             <a href="sschoolDetail.php"><i class="icon-chevron-right"></i><i class="icon-user"></i> Sabbath School Details</a>
           </li>

           <li>
             <a href="add_teen.php"><i class="icon-chevron-right"></i><i class="icon-plus-sign-alt"></i> Add Teenager
             </a>
           </li>
           <li>
             <a href="add_sundaysch.php"><i class="icon-chevron-right"></i><i class="icon-plus-sign-alt"></i> Add Sabbath School.
             </a>
           </li>
       ...
       <!------/.* System Log sidebar*------->
       <li>
         <a href="javascript:;" role="button" class="dropdown-toggle" data-toggle="collapse" data-target="#bs3"><i class="icon-chevron-right"></i><i class="icon-warning-sign"></i>&nbsp;System Logs
           <div class="muted pull-right"><i class="caret"></i></div>
         </a>
       ...
       <li>
         <a href="javascript:;" role="button" class="dropdown-toggle" data-toggle="collapse" data-target="#mr">
           <i class="icon-chevron-right"></i><i class="icon-user"></i>&nbsp;Report
           <div class="muted pull-right"><i class="caret"></i></div>
         </a>
         <ul id="mr" class="collapse">
           <li class="">
             <a href="Reservationreport.php"><i class="icon-chevron-right"></i><i class="icon-user"></i> Reservation</a>
           </li>

           <li>
             <a href="slotsreport.php"><i class="icon-chevron-right"></i><i class="icon-laptop"></i> Slots
             </a>
           </li>
