            ...
            <div class="navbar-inner">
               <div class="container-fluid">
				 ...
				 <div class="navbar-header">
                    ...
                    <span class="brand" href="#">Mt. Zion Seventh Day Adventists Church Admin Panel</span>
				 </div>
				  <!--.nav-collapse -->
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
									   ...
									   <a tabindex="-1" href="admin_change_picture.php" data-toggle="modal"><i class="icon-picture"></i>&nbsp;Change Picture</a>
                                    </li>
                                    <li class="divider"></li>
                                    <li>
