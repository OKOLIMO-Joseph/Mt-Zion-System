...
mysqli_query($conn,"insert into sundays(fname,sname,lname,Gender,birthday,residence,pob,ministry,mobile,thumbnail) 
values('$fname','$sname','$lname','$Gender','$birthday','$residence','$pob','$ministry','$mobile','uploads/none.png')")or die(mysqli_error());
